...
const objects = [
  ...
  // Map exits
  { id: 2, name: 'to-wilderness', x: 23 * 32, y: 9 * 32 },
  { id: 3, name: 'to-powhatan', x: 12 * 32, y: 1 * 32 },
...
const wildTmx = makeMap('wilderness', 20, 20,
  ...
  [
    ...
    // Squirrels
    { id: 34, name: 'squirrel-1', x: 5 * 32, y: 3 * 32 },
    { id: 35, name: 'squirrel-2', x: 3 * 32, y: 9 * 32 },
    { id: 36, name: 'squirrel-3', x: 7 * 32, y: 7 * 32 },
    { id: 37, name: 'squirrel-4', x: 4 * 32, y: 15 * 32 },
    // Wheat
    { id: 38, name: 'wheat-1', x: 10 * 32, y: 5 * 32 },
    { id: 39, name: 'wheat-2', x: 12 * 32, y: 8 * 32 },
    { id: 40, name: 'wheat-3', x: 9 * 32, y: 11 * 32 },
    // Carrots
